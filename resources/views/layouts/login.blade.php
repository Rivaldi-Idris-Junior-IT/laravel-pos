				...
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							...
							<form class="form-auth-small" action="{{ route('proses_login') }}" method="POST">
							@csrf
								...
								<div class="form-group">
									...
									<span clas="text-danger">@error('password') {{ $message }} @enderror</span>
								</div>								
								<button type="submit" class="btn btn-primary btn-lg btn-block">LOGIN</button>
								<div class="bottom">
									<span class="helper-text">Dont Have Account ?  <a href="{{ route('register') }}">Register Here </a></span>
								</div>
							</form>
						</div>
					</div>
